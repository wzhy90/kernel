...
ifeq ($(EOS),2)
CFLAGS_KERNEL	= -mtune=cortex-a9 -mfpu=vfpv3-d16 -ftree-vectorize -mfloat-abi=softfp -ffast-math -fsingle-precision-constant -marm --param l2-cache-size=1024 -funswitch-loops -w
endif

ifeq ($(EOS),1)
CFLAGS_KERNEL	= -mtune=cortex-a9 -mfpu=vfpv3-d16 -ftree-vectorize -ffast-math -fsingle-precision-constant -marm --param l2-cache-size=1024 -funswitch-loops -w
endif
